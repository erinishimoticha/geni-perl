# This Makefile is for the WWW::Geni extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/WWW/Geni.pm]
#     AUTHOR => q[Erin Spiceland <erin@thespicelands.com>]
#     BUILD_REQUIRES => {  }
#     NAME => q[WWW::Geni]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/WWW/Geni.pm]
...
TO_INST_PM = lib/WWW/Geni.pm

PM_TO_BLIB = lib/WWW/Geni.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/WWW/Geni.pm $(INST_MAN3DIR)/WWW::Geni.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               WWW-Geni' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for Geni.com' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Erin Spiceland <erin@thespicelands.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for Geni.com</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Erin Spiceland &lt;erin@thespicelands.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/WWW/Geni.pm blib/lib/WWW/Geni.pm 
